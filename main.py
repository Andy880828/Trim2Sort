...
class App(customtkinter.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.label = customtkinter.CTkLabel(self, text="Step0: Choose the sequence format",
                                            fg_color="transparent",
                                            text_color="#DCF3F0",
                                            font=("Consolas", 12, "bold"))
        self.label.grid(row=1, column=0, columnspan=2, padx=20, pady=(10, 5))

        self.button_sanger = customtkinter.CTkButton(self, text="Sanger", command=self.OpenSangerAnalysis)
        self.button_sanger.configure(fg_color="#2B4257",
                                     hover_color="#4C6A78",
                                     text_color="#DCF3F0",
                                     font=("Consolas", 12, "bold"),
                                     corner_radius=8)
        ...
        self.button_NGS.configure(fg_color="#2B4257",
                                hover_color="#4C6A78",
                                text_color="#DCF3F0",
                                font=("Consolas", 12, "bold"),
                                corner_radius=8)
